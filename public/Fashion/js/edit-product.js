/**
 * Created by Saints on 2/26/2017.
 */
$(document).ready(function(){
    ...
    var count = $('.colors-attr li').length;
    ...
    function makeData() {
        ...
        string = string.concat("&_product=");

        string = string.concat($('input[name=_product]').val());
    ...
    $('.item_add').on('click', function (e) {
        ...
        var a = $('input[name=_product]').val();

        var url = '/Product/'+ a +'/Edit';
    ...
    function submitImages(r) {
        ...
        sweetAlert("Congratulations", "Your product has been updated successfully.", "success");
